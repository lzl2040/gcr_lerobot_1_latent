...
def decode_video_frames_torchvision(
    ...
    # if video_end:
    #     print(f"[decode_video_frames_torchvision] Warning: reached end of video {video_path} before last timestamp {last_ts}. Loaded timestamps: {loaded_ts}")
    #     query_ts = torch.tensor([loaded_ts[-1]])
