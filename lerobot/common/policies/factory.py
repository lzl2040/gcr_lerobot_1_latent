...
def make_policy(
    ...
    if weight_pt_path:
        ...
        missing_key, unexpected_key = policy.load_state_dict(new_weights, strict=False)
        print(missing_key, unexpected_key)
        # with open("model_pi.txt", "w") as f:
